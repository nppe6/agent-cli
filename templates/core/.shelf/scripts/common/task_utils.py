...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .shelf/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .shelf)
    if "/" in normalized or normalized.startswith(".shelf"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.shelf/tasks/test'): {is_safe_task_path('.shelf/tasks/test', repo)}")
