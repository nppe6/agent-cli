...
When the user wants to change `agentos-research`, `agentos-implement`, or `agentos-check` behavior, edit platform agent files in the user project.
...
| Specific commands must run during checking | `agentos-check` |
