...
| `agentos-check` | Review changes, fix discovered issues, and run necessary checks. |
...
| Check agent must run project-specific commands | `agentos-check` agent file, and `.shelf/spec/` if needed. |
