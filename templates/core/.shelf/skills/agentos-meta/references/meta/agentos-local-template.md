...
description: |
  ...
  Inherits from agentos-meta for base architecture documentation.
...
This skill documents all customizations made to AgentOS Shelf in this project. For vanilla AgentOS Shelf documentation, see the `agentos-meta` skill.
