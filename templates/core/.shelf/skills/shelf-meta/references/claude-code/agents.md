...
Edit `.claude/agents/shelf-*.md` for Claude-specific behavior. If Codex is also enabled, usually update `.codex/agents/shelf-*.md` or the `.shelf/agents/` source and resync so both platforms stay aligned.
